    ...
    <div class="container">
        <div class="justify-center" style="display: flex; justify-content: center; margin-top: 6rem; margin-bottom: 4rem">
            <div
                ...
                <form class="space-y-3" method="POST" action="{{ Route('loginuser') }}">
                    @csrf
                    ...
                    {{-- <div id="toast-simple"
                        class="flex items-center w-full max-w-xs p-4 space-x-4 text-gray-500 bg-dark divide-x divide-gray-200 rounded-lg shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800"
                        role="alert">
