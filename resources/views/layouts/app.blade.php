...
<body>
    <header>
                        ...
                        <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-gray-200 rounded divide-y divide-yellow-100 shadow-lg  "
                            ...
                            <div class="grid grid-cols-3 gap-4 p-4">
                                <a href="/dashboard"
                                    ...
                                    <div class="text-sm text-gray-900 dark:text-white">Home</div>
                                </a>
                                <a href="{{ route('rekomendasi.user') }}"
                                    ...
                                    <div class="text-sm text-gray-900 dark:text-white">For You</div>
                                </a>
                                <a href="#"
                                    class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                                    <svg class="mx-auto mb-1 w-7 h-7 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                                    ...
                                    <div class="text-sm text-gray-900 dark:text-white">Discount</div>
                                </a>
                            </div>
                        </div>
                        <button type="button"
        ...
        <div id="drawer-navigation"
            ...
            tabindex="-1" aria-labelledby="drawer-navigation-label" style="margin-top: 4rem">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <button id="dropdownHoverButton" data-dropdown-toggle="dropdownHover"
                            ...
                            <span class="ml-3" style="color: black; font-size: 1rem">Product</span>
                            <svg class="w-2.5 h-2.5 ml-2.5" style="color: black" aria-hidden="true"
                        ...
                        <div id="dropdownHover"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <li>
                                    <a href="{{ Route('keychain') }}"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Keychain</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Cleaner</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Equipment</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Other
                                        Accessories</a>
                                </li>
                            </ul>
                        </div>
    ...
    @else
        <div id="toast-bottom-right"
            ...
            <div class="text-sm font-normal">
                <a data-modal-target="bottom-right-modal" data-modal-toggle="bottom-right-modal"
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        <input class="w-full rounded-lg" type="text" placeholder="{{ Auth::user()->nama_lengkap }}">
                        <input class="w-full rounded-lg" type="text" placeholder="{{ Auth::user()->email }}">
                        <textarea class="w-full rounded-lg" name="pesan" id="pesan" cols="30" rows="10"
                            placeholder="Masukan pesan disini..."></textarea>
                    </div>
                    <!-- Modal footer -->
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button data-modal-hide="bottom-right-modal" type="button"
    ...
    <footer class="bg-yellow-300 dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl p-8 py-6 lg:py-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400" style="margin-left: 30rem">©
                    2023 <a href="https://flowbite.com/" class="hover:underline">Mhazel-Shop</a>. All Rights Reserved.
                </span>
