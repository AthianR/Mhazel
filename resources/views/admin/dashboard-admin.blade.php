...
@section('content')
    <div class="container">
        <div class="pb-4 pt-4">
            <div class="p-4 border-2 border-gray-900 border-dashed rounded-lg dark:border-gray-700">
                <div class="grid grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-4">
                    <div class="w-full h-full p-2 items-center justify-center h-96 rounded bg-gray-50 dark:bg-gray-800">
                        <div
                            class="p-4 bg-white h-full md:h-24 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex-shrink-0">
                                    <span
                                        class="text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white">Rp. {{ number_format($data) }}</span>
                ...
                {{-- <div class="grid gap-4 xl:grid-cols-4 2xl:grid-cols-3">
                    <!-- Main widget -->
