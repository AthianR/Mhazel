                        ...
                        <div class="p-4 flex items-center justify-between pb-4 bg-white dark:bg-gray-900">
                            <div>
                                ...
                                <div id="dropdownAction"
                                    ...
                                    <div class="py-1">
                                        <button type="submit" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 focus:outline-none focus:bg-red-700">
                                ...
                                @foreach ($data as $item)
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            <img class="w-10 h-10 rounded-full" src="../icon/android-icon-36x36.png"
                                                alt="Jese image">
                                            <div class="pl-3">
