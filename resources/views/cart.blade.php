    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr
                                ...
                                <th scope="row" class="px-6  font-semibold text-gray-900 dark:text-white">
                                    {{ $item->nama_produk }}
                                </th>
                                <td class="px-6">
                                    {{ $item->varian_produk }}
                ...
                <nav class="flex items-center justify-between pt-4 px-4 py-4" aria-label="Table navigation">
