...
@section('content')
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="title" style="font-weight: 500; text-align: center; font-size: 2rem; margin-bottom: 1rem">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mt-3">
                @foreach ($data as $item)
                    <div class="grid-container" style="-height: 100%; height: 100%">
                        ...
                        <div class="grid grid-cols-1">
                            <p style="text-align: center; font-size: 100%; font-weight: 500">Rp.{{ number_format($item->harga_produk) }}</p>
                        </div>
                        @guest
                            <div class="grid grid-cols-1">
